...
class CompteControllerTest extends TestCase
{
    ...
    {
    $response = $this->getJson('/senghorfallou/v1/comptes?page=abc&limit=150&type=invalid&statut=invalid&sort=invalid&order=invalid');

    $response->assertStatus(422)
         ->assertJsonValidationErrors(['page', 'limit', 'type', 'statut', 'sort', 'order']);
    }
    ...
    $response = $this->getJson('/senghorfallou/v1/comptes?page=1&limit=10&type=epargne&statut=actif&sort=solde&order=desc');

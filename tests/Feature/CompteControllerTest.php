...
class CompteControllerTest extends TestCase
{
    ...
    {
        $response = $this->getJson('/api/v1/comptes?page=abc&limit=150&type=invalid&statut=invalid&sort=invalid&order=invalid');
    ...
    public function test_index_validation_passes_with_valid_parameters(): void
    {
        ...
        $response = $this->getJson('/api/v1/comptes?page=1&limit=10&type=epargne&statut=actif&sort=solde&order=desc');
